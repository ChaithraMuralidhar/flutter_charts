...
class ScatterChartSimple extends StatefulWidget {
  ScatterChartSimple({super.key});

  final blue1 = AppColors.contentColorBlue.withOpacity(0.5);
  final blue2 = AppColors.contentColorBlue;

  @override
  State<StatefulWidget> createState() => ScatterChartSimpleState();
}

class ScatterChartSimpleState extends State<ScatterChartSimple> {
  final maxX = 50.0;
  final maxY = 50.0;
  final radius = 8.0;
