...
class ScatterNoCorrelation extends StatefulWidget {
  const ScatterNoCorrelation({super.key});

  @override
  State<StatefulWidget> createState() => _ScatterNoCorrelationState();
}

class _ScatterNoCorrelationState extends State {
  int touchedIndex = -1;
          ...
          scatterSpots: [
            ScatterSpot(
              ...
              color: selectedSpots.contains(0)
                  ...
                  : AppColors.contentColorNavy.withOpacity(0.5),
            ),
            ScatterSpot(
              2,
              5,
